...
| [`handoff-copy.ts`](./handoff-copy.ts) | The personalized chat hand-off copy (intro line, the three opening chips, authority notes, coach-verify line). States no academic outcome. |

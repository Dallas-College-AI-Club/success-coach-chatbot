...
export const SimpleShell = ({
  ...
  return (
    <div
      className={`${skin.surface} flex h-[min(720px,calc(100dvh_-_8.5rem))] w-full flex-col gap-3 p-3 sm:p-4`}
    >
      <div
        ref={scrollRef}
      ...
      >
        ...
        {done ? (
          <div className="motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2 flex flex-col gap-3 motion-safe:duration-500">
            <div className="flex items-start gap-2">
              <MiniBot />
              <div data-role="assistant" className={skin.bubble}>
                <h1
                ...
                {done.resumed && done.summary.length > 0 && (
                  <div className="mt-2">
                    <p className="coach-helper text-[13px] font-semibold text-[#2E2555]/70">
                    ...
                    <ul className="mt-1.5 flex flex-col gap-1">
                      {done.summary.map((line, i) => (
                        ...
                        >
                          <span
                            aria-hidden
                            className="coach-accent mt-0.5 text-[#6C5CE7]"
                          >
                            ✓
                          </span>
                          <span>{line}</span>
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div data-role="assistant" className={skin.bubble}>
                ...
                {api.stepIdx === 0 && (
                  <p className="coach-helper mt-1 text-sm text-[#2E2555]/70">
                    {copy.reassurance}
                  </p>
                )}
              </div>

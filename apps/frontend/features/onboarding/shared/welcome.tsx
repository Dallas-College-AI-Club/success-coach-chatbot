    ...
    <main className="coach-page coach-playful relative flex min-h-dvh w-full flex-col items-center justify-center gap-7 bg-[#ECECEC] p-6 pt-20 text-[#1E2A3A] sm:pt-6">
      ...
      <div className="motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-3 flex w-full max-w-md flex-col items-center gap-6 text-center motion-safe:duration-500">
        ...
        <div className="flex items-center gap-2 text-left">
          <BotAvatar />
          <p className="coach-helper max-w-xs text-sm text-[#1E2A3A]/70">
            {canPick
        ...
        {returning && (
          <>
            <button
              ...
              className="coach-option flex w-full items-center gap-3 rounded-2xl border-2 border-[#003385] bg-white px-4 py-3 text-left shadow-sm transition-all hover:bg-[#003385]/[0.04] focus-visible:ring-2 focus-visible:ring-[#003385] focus-visible:ring-offset-2 motion-safe:active:scale-[0.99]"
            >
              <span className="text-2xl" aria-hidden>
                👋
              </span>
              <span className="flex flex-col">
                <span className="coach-heading font-semibold text-[#003385]">
                  Welcome back!
                </span>
              ...
              <span
                aria-hidden
                className="coach-heading ml-auto text-lg text-[#003385]"
              >
                →
              </span>
            </button>
            {canPick && (
              <p className="coach-helper -mb-1 text-xs font-medium tracking-wide text-[#1E2A3A]/40 uppercase">
                Or start fresh
              </p>
            )}
          </>
            ...
            {modes.map((m) => {
              ...
              return (
                <button
                  ...
                  aria-checked={on}
                  onClick={() => setPicked(m)}
                  className={`coach-option flex items-center gap-3 rounded-2xl border-2 bg-white px-4 py-3 text-left transition-all focus-visible:ring-2 focus-visible:ring-[#E52626] focus-visible:ring-offset-2 ${
                    on
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className={`coach-accent ml-auto text-lg text-[#E52626] transition-opacity ${
        ...
        <Button
          ...
          className="coach-primary h-12 w-full max-w-xs rounded-full bg-[#003385] text-base font-semibold text-white hover:bg-[#00276a] motion-safe:active:scale-[0.98]"
        >
          Start →
        </Button>

        <p className="coach-helper text-xs text-[#1E2A3A]/45">
          Your answers are saved just for you in this browser, not to your
          student record.
        </p>
      </div>
    </main>

...
//       if (!normalized) {
//         throw new ToolInputError(`"courseCode" cannot be empty.`);
//       }
...
//     async execute(input: GetCourseInfoInput): Promise<CourseInfoResult> {
//       if (process.env.NODE_ENV !== "production") {
//         console.log(`[TOOL] get_course_info invoked for ${input.courseCode}`);
//       }
...
//         requisites_raw:
//           (facts.requisites_raw as string | null | undefined) ?? null,

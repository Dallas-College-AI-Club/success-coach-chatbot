...
// NOTE for new routes: onnxruntime's native binary is traced per route — a
// new route importing this module must also be added to
// outputFileTracingIncludes in next.config.ts, or it dies on Vercel with

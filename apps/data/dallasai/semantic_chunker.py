...
class SemanticChunker:
    ...
    def __init__(self, chunk_size: int = None, chunk_overlap: int = None, env_path: Path = None):
        ...
        self.chunk_size = chunk_size or (int(env_chunk_size) if env_chunk_size else 2000)
        self.chunk_overlap = chunk_overlap or (int(env_chunk_overlap) if env_chunk_overlap else 200)
    ...
    def chunk_markdown(self, markdown_text: str, source_file: str = "") -> list[dict]:
        """
    ...
    def _process_section(self, section: dict, metadata: dict, source_file: str) -> list[dict]:
        """
    ...
    def _split_into_atoms(self, text: str, prefix_len: int) -> list[tuple[str, str]]:
        """
    ...
    def _split_into_sentences(self, text: str) -> list[str]:
        ...
        """
        abbreviations = ["Dr", "Prof", "Bldg", "Rm", "Jan", "Feb", "Mar", "Apr", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "vs", "etc", "e.g", "i.e"]

...
> [`apps/data/pipeline/`](../../apps/data/dallasai/pipeline/) and have collectively fetched
...
|---|---|---|
| [`archive_syllabi_cv.py`](../../apps/data/dallasai/pipeline/archive_syllabi_cv.py) | Concourse syllabus + instructor-CV pages, driven by schedule-CSV work-lists | ✅ ran 8 terms, Spring 2024–Summer 2026 (~32k syllabi + ~3.1k CVs on disk) |
| [`catalog_fetch.py`](../../apps/data/dallasai/pipeline/catalog_fetch.py) | Acalog catalog: 337 degree plans (306 in the by-Program index + 31 academic-transfer degrees) + every course they reference | ✅ ran the 2026-2027 catalog (~2k pages: 337 programs + ~1.7k courses) |
| [`run_archive_today.py`](../../apps/data/dallasai/pipeline/run_archive_today.py) | Self-healing driver: discovers every schedule CSV, runs CVs then per-term syllabi | ✅ overnight-safe |
